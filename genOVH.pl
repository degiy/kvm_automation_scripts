...
@vms= (
    ...
    [ 'dmz-b'          ,'db',1,1,2,102, ['int','cld']            , 'c76', $me1 ],
    [ 'load-balancer-a','la',1,2,2,111, ['int','ing','cll','sto'], 'c76', $me1 ],
    [ 'load-balancer-b','lb',1,2,2,112, ['int','ing','cll','sto'], 'c76', $me1 ],
    [ 'fuse-a',         'fa',2,4,8,121, ['int','ing','esb']      , 'c76', $me1 ],
    [ 'fuse-b',         'fb',2,4,8,122, ['int','ing','esb']      , 'c76', $me1 ],
    [ 'broker-a',       'ba',2,2,4,131, ['esb','sto']            , 'c76', $me1 ],
    [ 'broker-b',       'bb',2,2,4,132, ['esb','sto']            , 'c76', $me1 ],
    [ 'data-store-a',   'sa',1,1,10,141,['sto','cls']            , 'c76', $me1 ],
    [ 'data-store-b',   'sb',1,1,10,142,['sto','cls']            , 'c76', $me1 ],
    [ 'tools',          'to',1,1,20,100,[]                       , 'c76', $me1 ]
    );
...
";	 
	...
	print FV "\
#interface $name
ip link add veth_${id}_${num}_host type veth peer name veth_${id}_${num}_br
ip link set veth_${id}_${num}_host up
ip link set veth_${id}_${num}_br up
brctl addif br_${num}_${id} veth_${id}_${num}_br
ip a add ${net}.1/24 dev veth_${id}_1_host
