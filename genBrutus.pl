...
@interfaces=(
    ...
    [ 'dmz-in'               ,'dmi'   ,'10.80.1',101,$eno ],
    [ 'dmz-out'              ,'dmo'   ,'10.80.2',102,$eno ],
    [ 'dmz-admin'            ,'dma'   ,'10.80.3',103,$eno ],
    [ 'cluster-brutus'       ,'clb'   ,'10.80.4',104,$eno ],
    );
...
@vms= (
    [ 'brutus-a'          ,'bra',8,8,16,201, ['dmi','dmo','dma','clb']  , 'c76', $me1 ],
    [ 'brutus-b'          ,'brb',8,8,16,202, ['dmi','dmo','dma','clb']  , 'c76', $me1 ],
    [ 'brutus-tool'       ,'brt',4,4,8,  99, ['dmi','dmo'            ]  , 'c76', $me1 ],
    [ 'brutus-supv'       ,'brs',4,4,8,  60, ['dma'                  ]  , 'c76', $me1 ]
    );
